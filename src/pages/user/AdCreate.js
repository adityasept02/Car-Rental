...
export default function AdCreate() {
    ...
    return (
        <div>
        <div class="container cursor-pointer" style={{padding: "2rem"}}>
        <div class="row cursor-pointer">
          <div class="mx-auto">
            <h1 className="display-4 text-center cursor-pointer" style={{ fontFamily: "Veranda cursor-pointer" }}>
              Create Listing 
            </h1>
            <Sidebar />
          </div>
                    ...
                    {sell && (
                        <div className="my-1">
                            <button onClick={() => navigate("/ad/create/sell/House")} 
                                    className="btn btn-secondary p-3 col-6">Car</button>
